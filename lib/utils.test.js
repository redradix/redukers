import { matchPattern, fluxPayloadActions, fluxErrorActions } from './utils'
...
describe('fluxPayloadActions', () => {
  it('works', () => {
    const { exampleAction } = fluxPayloadActions('FOO')
...
describe('fluxErrorActions', () => {
  it('works', () => {
    const { exampleAction } = fluxErrorActions('FOO')
